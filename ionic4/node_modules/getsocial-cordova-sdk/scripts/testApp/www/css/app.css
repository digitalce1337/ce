...
.header h4 { margin-left: 50px; word-break: break-all; }
.header h5 { margin-left: 50px; word-break: break-all; }
.header img { float: left; border-radius: 50%;}
.clear { clear: both; }
