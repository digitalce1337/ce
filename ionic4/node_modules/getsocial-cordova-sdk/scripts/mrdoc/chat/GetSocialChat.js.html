      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../chat/GetSocialChat.js.html">chat/GetSocialChat.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#ChatViewBuilder"><i class="alert alert-success"></i><span>ChatViewBuilder</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="ChatViewBuilder">
            <h1>ChatViewBuilder</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>&nbsp;</span><span>ChatViewBuilder</span><span>&nbsp;</span>
            </p>
          </section>
          ...
          <pre><code class="language-javascript">var ChatViewBuilder = require('./ChatViewBuilder');
...
module.exports = GetSocialChat;</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
