      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../entity/Leaderboard.js.html">entity/Leaderboard.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#LeaderboardScore"><i class="alert alert-success"></i><span>LeaderboardScore</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="LeaderboardScore">
            <h1>LeaderboardScore</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>&nbsp;</span><span>LeaderboardScore</span><span>&nbsp;</span>
            </p>
          </section>
          ...
          <pre><code class="language-javascript">var LeaderboardScore = require('./LeaderboardScore');
...
module.exports = Leaderboard;</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
