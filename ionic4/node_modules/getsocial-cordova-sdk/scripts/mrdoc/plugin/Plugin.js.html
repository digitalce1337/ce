      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../plugin/Plugin.js.html">plugin/Plugin.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#Plugin"><i class="alert alert-info"></i><span>Plugin</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="Plugin">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>&nbsp;</span><span>Plugin()</span><span>&nbsp;</span>
            </p>
          </section>
          ...
          <pre><code class="language-javascript">var Plugin = function() {
