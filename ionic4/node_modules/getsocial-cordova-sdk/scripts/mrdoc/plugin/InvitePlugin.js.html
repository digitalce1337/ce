      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../plugin/InvitePlugin.js.html">plugin/InvitePlugin.js</a></li>
            <li><a href="../plugin/Plugin.js.html">plugin/Plugin.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#Plugin"><i class="alert alert-success"></i><span>Plugin</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="Plugin">
            ...
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>&nbsp;</span><span>Plugin</span><span>&nbsp;</span>
            </p>
          </section>
          ...
          <pre><code class="language-javascript">var Plugin = require('./Plugin')
...
module.exports = InvitePlugin;</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
