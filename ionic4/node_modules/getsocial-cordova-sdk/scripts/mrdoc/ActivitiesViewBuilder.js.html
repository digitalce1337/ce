      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="ActivitiesViewBuilder.js.html">ActivitiesViewBuilder.js</a></li>
            <li><a href="Configuration.js.html">Configuration.js</a></li>
            <li><a href="CurrentUser.js.html">CurrentUser.js</a></li>
            <li><a href="GetSocial.js.html">GetSocial.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#ViewBuilder"><i class="alert alert-success"></i><span>ViewBuilder</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="ViewBuilder">
            <h1>ViewBuilder</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>&nbsp;</span><span>ViewBuilder</span><span>&nbsp;</span>
            </p>
          </section>
          <div class="description"><p>Copyright 2015-2016 GetSocial B.V.</p><pre><code>Licensed under the Apache License, Version 2.0 (the &quot;License&quot;);
...
limitations under the License.
          ...
          <pre><code class="language-javascript">var ViewBuilder = require('./ViewBuilder')

var NATIVE_BRIDGE_NAME = &quot;GetSocialCordova&quot;;

var ActivitiesViewBuilder = function(group, tags) {
  this.group = null;
  this.tags = null;
  if((group == undefined) &amp;&amp; (tags == undefined)) {
  ...
  ActivitiesViewBuilder.prototype.show = function() {
    ...
    cordova.exec(null, null, NATIVE_BRIDGE_NAME, &quot;createActivitiesView&quot;, [option]);
  }

  ActivitiesViewBuilder.prototype.close = function() {
    var option = {}
    cordova.exec(null, null, NATIVE_BRIDGE_NAME, &quot;closeActivitiesView&quot;, [option]);
  }

ActivitiesViewBuilder.prototype.__proto__ = ViewBuilder.prototype;

module.exports = ActivitiesViewBuilder;</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
