      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="SmartInviteViewBuilder.js.html">SmartInviteViewBuilder.js</a></li>
...
var SmartInviteViewBuilder = function() {
  ...
  SmartInviteViewBuilder.prototype.setImagePath = function(imagePath) {
  ...
  SmartInviteViewBuilder.prototype.show = function() {
    ...
    if(this.imagePath != null) {
      option.imagePath = this.imagePath;
    }

    cordova.exec(null, null, NATIVE_BRIDGE_NAME, &quot;createSmartInviteView&quot;, [option]);
  }

  SmartInviteViewBuilder.prototype.close = function() {
    var option = {}
    cordova.exec(null, null, NATIVE_BRIDGE_NAME, &quot;closeSmartInviteView&quot;, [option]);
  }

SmartInviteViewBuilder.prototype.__proto__ = ViewBuilder.prototype;

module.exports = SmartInviteViewBuilder;</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
