...
var AddoperatorPage = /** @class */ (function () {
    ...
    AddoperatorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addoperator',template:/*ion-inline-start:"C:\Users\qingt\Documents\Korean App\ionic\ionic_koreanapp\src\pages\addoperator\addoperator.html"*/'\n<!--\n  Generated template for the AddoperatorPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title >{{ title }}</ion-title>\n    <ion-buttons>\n      <button ion-button (click)="closeModal()">\n          <ion-icon name="arrow-back"></ion-icon>  \n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-item>\n    <ion-label stacked>{{ email }}</ion-label>\n    <ion-input type="text" [(ngModel)]="emailField"></ion-input>\n  </ion-item>\n\n</ion-content>\n<ion-footer no-shadow>\n    <button full ion-button (click)="itemTappedAdd($event)">{{ add }}</button>\n</ion-footer>\n'/*ion-inline-end:"C:\Users\qingt\Documents\Korean App\ionic\ionic_koreanapp\src\pages\addoperator\addoperator.html"*/,
        }),
